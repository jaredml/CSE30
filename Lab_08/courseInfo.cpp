...
int main()
{
	...
	my_line = new string;
        ...
        school = new Course;
	(school->startTime) = new Time;
	(school->endTime) = new Time;
	int *classes, *lines; //keep track of lines and number of courses
	classes = new int;
	lines = new int;
	*classes = 1;
	*lines = 1;
	...
	delete my_line, school, (school->startTime),(school->endTime), classes, lines;
        return 0;
}
